    ...
    <main className="pt-20 min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="bg-white rounded-3xl border border-border shadow-xl p-8">
          ...
          {/* Google Sign In */}
          <button
            onClick={() => signInWithGoogle('DERMATEK')}
            className="w-full py-3 bg-white border-2 border-border rounded-xl font-medium text-foreground hover:bg-muted transition-all flex items-center justify-center gap-3"
          >
