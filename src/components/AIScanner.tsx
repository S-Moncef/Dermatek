...
export default function AIScanner() {
  ...
  const startScan = useCallback(async () => {
    ...
    const mockResult: DiagnosticResult = {
      ...
      healthScore: 78,
      recommendations: [
        'Hydratation quotidienne recommandée',
        'Protection solaire SPF 30+ conseillée',
      ...
      try {
        await fetch('/api/diagnostics', {
          ...
          body: JSON.stringify({
            ...
            skin_type: mockResult.skinType,
            health_score: mockResult.healthScore,
            recommendations: { items: mockResult.recommendations }
          })
        });
      } catch (err) {
